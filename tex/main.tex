...
\subsection{Game Build}
Attached to the submission is a PC-build of the mobile game prototype \textit{Rat Kid Dog Fight!}\

To play the prototype, unpack the zip-file and run the file \textit{RatKidDogFight.exe} . \
