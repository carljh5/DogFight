...
We chose a vertical (instead of horizontal) display for the phone for accessibility and to signal the briefness of the play session. As mentioned in section \ref{story} we wanted to give a narrative reason for the actions of the player character. To tell this story of the street kid we use a text interface with simple pictures and animations.\
...
\subsection{Actions Between Fights} \label{weekly}
...
As mentioned in section \ref{Ethics} we wanted to
